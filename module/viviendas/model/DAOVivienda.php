<?php
	...
	class DAOVivienda{
		function insert_vivienda($datos){
			...
			$sql = "INSERT INTO vivenda(m2,tipo_vivenda,precio,fecha_publicacion,ubicacion,num_habs,referencia_catastral,Activo,opcion)" 
        			."VALUES('$m2','$tipo_vivenda','$precio','$fecha_publicacion','$ubicacion','$num_habs','$referencia_catastral','$Activo','$opcion')";
		...
		function update_vivienda($datos){
			...
			, ubicacion='$ubicacion', num_habs='$num_habs',"
				...
				Activo='$Activo', opcion='$opcion' WHERE id='$id'";
		...
		function dummies_vivienda(){
			...
			$sql.= "INSERT INTO vivenda(m2,tipo_vivenda,precio,fecha_publicacion,ubicacion,num_habs,referencia_catastral,Activo,opcion)" 
			."VALUES('100','piso','200000','19/10/2023','Ontinyent','4','1653H','On','compra:alquiler:');";
		
			$sql.= "INSERT INTO vivenda(m2,tipo_vivenda,precio,fecha_publicacion,ubicacion,num_habs,referencia_catastral,Activo,opcion)" 
			."VALUES('160','chalet','340000','02/06/2023','Benifaió','6','0867P','On','compra:alquiler:');";
			
			$sql.= "INSERT INTO vivenda(m2,tipo_vivenda,precio,fecha_publicacion,ubicacion,num_habs,referencia_catastral,Activo,opcion)" 
			."VALUES('30','trastero','10000','14/07/2023','Benidorm','1','1664J','On','compra:');";

			$sql.= "INSERT INTO vivenda(m2,tipo_vivenda,precio,fecha_publicacion,ubicacion,num_habs,referencia_catastral,Activo,opcion)" 
			."VALUES('90','piso','70000','12/05/2023','Muchamiel','3','5654L','On','compra:alquiler:');";

			$sql.= "INSERT INTO vivenda(m2,tipo_vivenda,precio,fecha_publicacion,ubicacion,num_habs,referencia_catastral,Activo,opcion)" 
			."VALUES('250','finca','500000','29/10/2023','Alfarrasi','9','1223K','On','compra:');";
